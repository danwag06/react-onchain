...
import type { InscriptionJob, InscriptionResult } from './parallelInscriber.js';
import type { FileReference, InscribedFile, ChunkManifest } from './types.js';
...
import { generateServiceWorkerRegistration } from './serviceWorkerGenerator.js';
import { isIndexHtmlFile } from './utils/inscription.js';
 ...
 */
export function calculateDependencyWaves(graph: Map<string, any>): DependencyWaves {
